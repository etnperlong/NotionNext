...
const SocialButton = () => {
  return <div className='space-x-3 text-xl text-gray-600 dark:text-gray-400 flex-wrap flex justify-center '>
      ...
      {siteConfig('CONTACT_MASTODON') && <a target='_blank' rel='noreferrer' href={siteConfig('CONTACT_MASTODON')} title={'mastoton'} >
        <i className='fab fa-mastodon transform hover:scale-125 duration-150 hover:text-green-600'/>
      </a>}
      {siteConfig('CONTACT_LINKS') && <a target='_blank' rel='noreferrer' href={siteConfig('CONTACT_LINKS')} title={'links'} >
