...
const BLOG = {
  ...
  CONTACT_MASTODON: process.env.NEXT_PUBLIC_CONTACT_MASTODON || '', // 你的mastodon个人主页
  CONTACT_LINKS: process.env.NEXT_PUBLIC_CONTACT_LINKS || '', // 你的自定义外链
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_MATRIX: process.env.NEXT_PUBLIC_CONTACT_MATRIX || '', // Matrix!
